                        ...
                        if (json &&
                            ...
                            json.data.me.memberships.forEach(function (m) {
                                m.workspace.clusters
                                    ...
                                    _this.addCluster(new Cluster_1.Cluster(_this.out, cluster.name, endpoint, _this.globalRC.cloudSessionKey, false, ['prisma-eu1', 'prisma-us1'].includes(cluster.name), true, m.workspace.slug));
                                });
                            });
