            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 8:
                        if (!(!isOnline &&
                            ...
                            (cluster.baseUrl.includes('127.0.0.1') ||
                                cluster.baseUrl.includes('localhost')))) return [3 /*break*/, 10];
                        return [4 /*yield*/, this.localUp()];
                    case 9:
                        cluster = _c.sent();
                        return [3 /*break*/, 11];
                    ...
                    case 13:
                        ...
                        if (!(cluster && !cluster.local)) return [3 /*break*/, 15];
                    ...
                    case 14:
                        ...
                        _c.label = 15;
                    case 15: return [4 /*yield*/, this.client.initClusterClient(cluster, this.definition.getWorkspace() || '*', serviceName, stage)];
                    case 16:
                        _c.sent();
                    ...
                    case 19:
                        ...
                        projectNew = true;
                        _c.label = 20;
                    case 20: return [4 /*yield*/, this.deploy(stage, serviceName, cluster, this.definition.definition.cluster, force, dryRun, projectNew, this.definition.getWorkspace())];
                    case 21:
                        _c.sent();
                        if (watch) {
